  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0a0a0f]">
      <div className="fixed inset-0">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-purple-500/8 rounded-full blur-[100px]" />
      </div>
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white">Dezafira Club</span>
          </Link>
        </div>
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-8">
          ...
          <p className="text-center text-gray-500 text-sm mb-6">Comece sua jornada agora</p>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1.5">Senha (mín. 6 caracteres)</label>
              <input
