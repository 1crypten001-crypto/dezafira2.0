...
async function init() {
    ...
    // Seed admin user. ADMIN_PASSWORD (env) é a fonte da verdade:
    // cria OU sincroniza o hash — corrige login quando o usuário já existe.
