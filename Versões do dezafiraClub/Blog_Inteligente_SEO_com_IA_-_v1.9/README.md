...
Destaques: importação automática do YouTube com IA (Google Gemini), **Web Stories AMP** com bolinhas estilo Instagram, feed inteligente (estilo YouTube), feeds Pinterest, anúncios, área de membros premium, produtos digitais, Asaas/Stripe, analytics com filtro de prefetch, **builder de Landing Pages v2 (drag-and-drop + CLI/API para agentes de IA)**, **Comunidade (fórum)** e **área de membros com tópicos**.

**Versão do pacote de distribuição:** `v1.9` — ver [docs/changelog-v1.9.md](docs/changelog-v1.9.md).
...
10. **📦 [Changelog v1.9](docs/changelog-v1.9.md)**: Novidades da v1.9 (builder de landings, comunidade, CLI/API com validação e rate limit).
11. **📦 [Changelog v1.7](docs/changelog-v1.7.md)**: Novidades do pacote v1.7.
...
Gera `Blog Inteligente SEO com IA - v1.9.zip` na raiz (sem `.env`, `.db` nem `node_modules`).
