<script lang="ts">
  ...
  function handlePaletteDragStart(type, e) {
    ...
    if (e?.dataTransfer) {
      ...
      try {
        ...
        ghost.style.cssText =
          'position:fixed;top:-1000px;left:-1000px;padding:8px 12px;background:#1d4ed8;color:#fff;border-radius:8px;font:700 12px/1 system-ui;';
  ...
  async function handleImageUpload(e, targetProp) {
    ...
    try {
      ...
      if (url) {
        if (targetProp === 'src' && selectedBlock) {
          selectedBlock.properties.src = url;
      ...
      <div class="elements-group-list">
        {#if leftSubTab === 'blocks'}
          ...
          <div class="elements-grid">
            ...
            <div class="element-item" draggable="true" ondragstart={(e) => handlePaletteDragStart('newsletter', e)} ondragend={handleDragEnd} onclick={() => handlePaletteClick('newsletter')}>
              <span class="elem-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              </span>
              <span class="elem-name">{t(lang, 'admin.landing_pages.builder.block_newsletter')}</span>
            </div>
          </div>
      ...
      <div class="settings-panel-content">
        {#if rightTab === 'page'}
          <div class="settings-form lp-page-settings-form">
            <h4 class="settings-group-title">{t(lang, 'admin.landing_pages.builder.settings')}</h4>
            
            <!-- 1. Identificacao -->
            <details class="lp-accordion" open>
              <summary class="lp-accordion-header">
                <span class="lp-accordion-title">📝 {t(lang, 'admin.landing_pages.builder.group_identification') || 'Identificação'}</span>
            ...
            <details class="lp-accordion">
              <summary class="lp-accordion-header">
                <span class="lp-accordion-title">🔍 SEO & {t(lang, 'admin.landing_pages.builder.group_social') || 'Redes Sociais'}</span>
                <span class="lp-accordion-icon">▾</span>
              </summary>
              <div class="lp-accordion-content">
                <div class="form-group">
            ...
            <details class="lp-accordion">
              <summary class="lp-accordion-header">
                <span class="lp-accordion-title">🎨 {t(lang, 'admin.landing_pages.builder.group_header_design') || 'Design & Cabeçalho'}</span>
                <span class="lp-accordion-icon">▾</span>
              </summary>
              <div class="lp-accordion-content">
                <div class="form-group">
                  <label>{t(lang, 'admin.landing_pages.builder.container_width')}</label>
                  <select bind:value={pageSettings.containerWidth}>
                    <option value="900px">{t(lang, 'admin.landing_pages.builder.width_narrow')}</option>
                    <option value="1200px">{t(lang, 'admin.landing_pages.builder.width_default')}</option>
                    <option value="1400px">{t(lang, 'admin.landing_pages.builder.width_wide')}</option>
                  </select>
                </div>

                <div class="form-group">
                  <label>{t(lang, 'admin.landing_pages.builder.page_bg')}</label>
                  <input type="color" bind:value={pageSettings.backgroundColor} />
                </div>
        ...
        {#if rightTab === 'block' && selectedBlock}
          <div class="settings-form">
            ...
            {#if selectedBlock.type === 'text' || selectedBlock.type === 'html'}
              <div class="form-group">
            ...
            {:else if selectedBlock.type === 'newsletter'}
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.label_title')}</label>
              ...
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.subtitle_field')}</label>
                <textarea bind:value={selectedBlock.properties.description} rows="3" oninput={pushHistory}></textarea>
              </div>
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.placeholder')}</label>
                <input type="text" bind:value={selectedBlock.properties.placeholder} oninput={pushHistory} />
              </div>
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.button_text')}</label>
                <input type="text" bind:value={selectedBlock.properties.buttonText} oninput={pushHistory} />
              </div>
              <p class="newsletter-hint" style="font-size: 0.8rem; color: #6b7280; margin-top: 0.5rem;">
                {t(lang, 'admin.landing_pages.builder.newsletter_hint')}
              </p>
        ...
        {#if rightTab === 'styles' && selectedBlock}
          <div class="settings-form">
            <h4 class="settings-group-title">{t(lang, 'admin.landing_pages.builder.tab_styles')}</h4>

            <div class="form-group">
              <label>{t(lang, 'admin.landing_pages.builder.align')}</label>
              <select bind:value={selectedBlock.styles.textAlign} onchange={pushHistory}>
                <option value="left">{t(lang, 'admin.landing_pages.builder.align_left')}</option>
                <option value="center">{t(lang, 'admin.landing_pages.builder.align_center')}</option>
                <option value="right">{t(lang, 'admin.landing_pages.builder.align_right')}</option>
              </select>
            </div>

            <div class="form-group">
              <label>{t(lang, 'admin.landing_pages.builder.text_color')}</label>
              <input type="color" bind:value={selectedBlock.styles.textColor} onchange={pushHistory} />
            </div>

            {#if selectedBlock.type === 'section' || selectedBlock.type === 'button'}
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.bg_color')}</label>
                <input type="color" bind:value={selectedBlock.styles.backgroundColor} onchange={pushHistory} />
              </div>
            {/if}

            {#if selectedBlock.type === 'text' || selectedBlock.type === 'button'}
              <div class="form-group">
                <label>{t(lang, 'admin.landing_pages.builder.font_size')}</label>
                <input type="text" bind:value={selectedBlock.styles.fontSize} oninput={pushHistory} />
              </div>
            {/if}

            <h4 class="settings-group-title" style="margin-top: 1rem;">{t(lang, 'admin.landing_pages.builder.spacing')}</h4>
            <div class="form-group">
              <label>{t(lang, 'admin.landing_pages.builder.padding_top')}</label>
              <input type="text" bind:value={selectedBlock.styles.paddingTop} oninput={pushHistory} />
            </div>
            <div class="form-group">
              <label>{t(lang, 'admin.landing_pages.builder.padding_bottom')}</label>
              <input type="text" bind:value={selectedBlock.styles.paddingBottom} oninput={pushHistory} />
            </div>
          </div>
        {/if}
      </div>
